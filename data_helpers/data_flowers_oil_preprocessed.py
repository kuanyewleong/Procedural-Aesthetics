...
class Flowers102Oil(Dataset):
    ...
    Reads Oxford-102 split/labels from .mat, but loads images from:
      {flowers_root}/jpg_oil/image_XXXXX.jpg
    """
    def __init__(self, root="./data", split="train", image_size=512, seed=0, data_dirname="jpg_oil"):
        ...
        if not self.water_dir.exists():
            raise FileNotFoundError(f"Oil folder not found: {self.water_dir}")
