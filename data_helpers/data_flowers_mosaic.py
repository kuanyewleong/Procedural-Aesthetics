...
class Flowers102Mosaic(Dataset):
    """
    Stage-2 mosaic dataset:
      - base image from Flowers102Clean
      - run mosaic stylizer
      - caption includes canonical species prefix + mosaic style keywords
    """
    def __init__(
        self,
        root="./data",
    ...
    def __getitem__(self, idx):
        ...
        # canonical mosaic caption based on true species
        name = b["name"]
        caption = make_mosaic_caption(name, rng=self.rng)
