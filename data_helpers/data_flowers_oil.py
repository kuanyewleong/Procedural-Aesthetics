...
class Flowers102Oil(Dataset):
    """
    Stage-2 oil painting dataset:
      - base image from Flowers102Clean
      - run oil painting stylizer
      - caption includes canonical species prefix + oil painting style keywords
    """
    def __init__(
        self,
        root="./data",
        ...
        assert stylize_fn is not None, "Provide stylize_fn(img01)->img01 for oil painting style."
    ...
    def __getitem__(self, idx):
        ...
        # canonical oil painting caption based on true species
        name = b["name"]
        caption = make_oil_caption(name, rng=self.rng)
