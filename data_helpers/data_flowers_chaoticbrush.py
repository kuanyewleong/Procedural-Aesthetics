...
class Flowers102ChaoticBrushes(Dataset):
    """
    Stage-2 chaotic brushes dataset:
      - base image from Flowers102Clean
      - run chaotic brushes stylizer
      - caption includes canonical species prefix + chaotic brushes style keywords
    """
    def __init__(
        self,
        root="./data",
    ...
    def __getitem__(self, idx):
        ...
        # canonical chaotic brushes caption based on true species
        name = b["name"]
        caption = make_chaotic_brushes_caption(name, rng=self.rng)
