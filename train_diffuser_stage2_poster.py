...
from data_helpers.data_flowers_poster import Flowers102Poster
...
def train_stage2_poster(
    ...
    # ---- dataset ----
    ds = Flowers102Poster(split="train", image_size=image_size, posterize_fn=stylize_fn)
